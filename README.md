...
npm run input-check                 # axes plus W/S/Shift/Space and W+S chord intent
...
npm run high-g-check                # the turn/energy trade and independent Space airbrake
